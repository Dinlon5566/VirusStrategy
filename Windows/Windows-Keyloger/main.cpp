...
int main(int argc,char* argv[])
{
    ...
    sprintf(filepath, "%s\\%s%s", basepath.c_str(), filename,FILE_SUFFIX);
    ...
    while(1)
    {
        Sleep(2);
        char title[1024];
        HWND hwndHeader=GetForegroundWindow();
        GetWindowText(hwndHeader,title,1023);
        ...
        {
            SHORT keyin=GetAsyncKeyState(c);
